...

{
  id: "char_create",
  type: "charCreate",
  text: "어둠이 내려앉은 숲 입구에서, 당신은 자신을 기억해내야 합니다. /n 지혜(WIS) : qte난이도에 영향을 미칩니다. 특수한 선택지를 열어줍니다. 체력(VIT): 실패를 견딜 수 있는 횟수입니다. 강인한 선택지를 열어줍니다. agi(민첩): qte 난이도에 영향을 미칩니다. 날렵한 선택지를 열어줍니다.",
  image: null,
  choices: []
},
